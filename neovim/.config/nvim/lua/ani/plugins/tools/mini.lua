return {
	...
	version = false,
	config = function()
		require("mini.icons").setup( -- No need to copy this inside `setup()`. Will be used automatically.
			{
		...
		-- --------------------------------------------------------------------------------------------------------------------
		require("mini.tabline").setup( -- No need to copy this inside `setup()`. Will be used automatically.
			{
