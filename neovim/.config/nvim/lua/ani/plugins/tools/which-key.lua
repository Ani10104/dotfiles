return {
	...
	config = function(_, opts)
		...
		wk.add({
			...
			{ "<F1>", desc = "Save all" },
			{ "<F2>", desc = "VimTeX Compile" },
			{ "<F3>", desc = "VimTeX View" },
			{ "<F9>", desc = "Toggle all folds" },
			...
			{ "<leader>r", group = "Reload", icon = { icon = "󰑓", color = "orange" } },
			{ "<leader>rs", desc = "Reload LuaSnip snippets", icon = { icon = "", color = "green" } },
			{ "<leader>rc", desc = "Reload Neovim config", icon = { icon = "", color = "blue" } },
			...
			{ "<leader>v", group = "VimTeX", icon = { icon = "", color = "purple" } },
			{ "<leader>vd", desc = "Delete LaTeX environment" },

			{ "<leader>t", group = "Typst", icon = { icon = "", color = "blue" } },
			-- Up = " ",
			-- Down = " ",
			-- Left = " ",
			-- Right = " ",
			...
			-- F11 = "󱊵",
			-- F12 = "󱊶",
			{ "<leader>c", desc = "Create split", icon = { icon = "󰤼", color = "yellow" } },
			{ "<leader>j", desc = "Close split", icon = { icon = "", color = "red" } },
			{ "<leader>k", desc = "Maximize split", icon = { icon = "", color = "cyan" } },

			{ "<leader>z", desc = "Zen Mode", icon = { icon = "", color = "orange" } },
			{ "<leader>q", desc = "Quit to dashboard" },
		})
